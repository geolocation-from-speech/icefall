...
import k2
from sotctc_graph_compiler import SOTCTCGraphCompiler
import torch
...
def decode_one_batch(
    ...
    model: nn.Module,
    graph_compiler: SOTCTCGraphCompiler,
    batch: dict,
...
def main():
    ...
    #test_sets = ["snyth", "l2m_test", "ls_test_other", "ls_test_clean", "lcss"]
    #test_dl = [synth_dl, l2m_test_both_dl, ls_test_other_dl, ls_test_clean_dl, lcss_dl]
    test_sets = ["ami_dev"]
    test_dl = [ami_dev_dl]
