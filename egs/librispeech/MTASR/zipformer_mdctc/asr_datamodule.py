...
class LibriSpeechAsrDataModule:
    ...
    def train_cuts(self) -> CutSet:
        ...
        cut_info = [
            ('audioset', 0.99, "./data/manifests/cuts_audioset_train_shuffled.jsonl.gz"),
            ('librispeech_0', 0.0025, "./data/manifests/cuts_librispeech_train_shuffled_0.jsonl.gz"),
            ('librispeech_1', 0.0025, "./data/manifests/cuts_librispeech_train_shuffled_1.jsonl.gz"),
            ('librispeech_2', 0.0025, "./data/manifests/cuts_librispeech_train_shuffled_2.jsonl.gz"),
            ('librispeech_3', 0.0025, "./data/manifests/cuts_librispeech_train_shuffled_3.jsonl.gz"),
        ]
        ...
        cs_iter = CutSpliceIterable(
            ...
            max_unique=1,
            max_overlap=[1, 1, 1, 1, 1],
            max_snr=[30, 30, -30, 0, 0,],
    ...
    def valid_cuts(self) -> CutSet:
        ...
        cut_info = [
            ('audioset', 0.9, "./data/manifests/cuts_audioset_eval_0.jsonl.gz"),
            ('dev-clean', 0.05, "./data/manifests/cuts_librispeech_dev-other.jsonl.gz"),
            ('dev-other', 0.05, "./data/manifests/cuts_librispeech_dev-clean.jsonl.gz"),
        ]
        cutsets, weights, names = [], [], []
        for n, w, p in cut_info: 
            cutsets.append(load_manifest_lazy(p))
