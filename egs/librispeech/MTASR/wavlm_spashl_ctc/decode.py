...
def main():
    ...
    #test_sets = ["synth", "l2m_test", "ls_test_other", "ls_test_clean", "lcss", "ami_dev"]
    #test_dl = [synth_dl, l2m_test_both_dl, ls_test_other_dl, ls_test_clean_dl, lcss_dl, ami_dev_dl]
    #test_sets = ["synth", "libri3mix", "l2m_test_clean", "l2m_test_both", "ls_test_other", "ls_test_clean", ] #"lcss", "ami_dev"]
    #test_dl = [synth_dl, l3m_test_clean_dl, l2m_test_clean_dl, l2m_test_both_dl, ls_test_other_dl, ls_test_clean_dl,] # lcss_dl, ami_dev_dl]
    test_sets = ["synth", "libri3mix", "l2m_test_clean", "l2m_test_both", "ls_test_other", "ls_test_clean", "lcss", "ami_dev"]
    test_dl = [synth_dl, l3m_test_clean_dl, l2m_test_clean_dl, l2m_test_both_dl, ls_test_other_dl, ls_test_clean_dl, lcss_dl, ami_dev_dl]
    ...
    #test_sets = ["synth", "l2m_test_clean"]
    #test_dl = [synth_dl, l2m_test_clean_dl]
    #test_sets = ["synth"]
    #test_dl = [synth_dl]
