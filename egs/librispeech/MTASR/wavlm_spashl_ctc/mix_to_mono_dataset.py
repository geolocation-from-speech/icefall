...
class K2MixToMonoDataset(torch.utils.data.Dataset):
    ...
    * ``F`` - number of features
    ...
    def __init__(
        ...
        :param sort_strategy: The sorting strategy for supervisions
        """
    ...
    def __getitem__(self, cuts: CutSet) -> Dict[str, Union[torch.Tensor, List[str]]]:
        ...
        # correct order.  
        if self.sort_strategy == "start_time": 
        ...
        elif self.sort_strategy == "speech_time":
