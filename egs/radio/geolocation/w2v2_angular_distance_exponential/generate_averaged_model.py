...
from geolocation_datamodule import RadioGeolocationDataModule
import argparse
...
def get_parser():
    ...
    parser.add_argument(
        "--exp-dir",
        type=str,
        default="hubert_geolocation/exp4",
        help="The experiment dir",
    )

    #parser.add_argument("--feat-enc-layers", type=str,
    #    default="[(512,10,5)] + [(512,3,2)] * 4 + [(512,2,2)] * 2"
    #)
    #parser.add_argument("--encoder-dim", type=int, default=768)
    #parser.add_argument("--num-layers", type=int, default=12)
    #parser.add_argument("--num-heads", type=int, default=12)
    #parser.add_argument("--ffdim", type=int, default=3072)
...
def main():
    parser = get_parser()
    RadioGeolocationDataModule.add_arguments(parser)
